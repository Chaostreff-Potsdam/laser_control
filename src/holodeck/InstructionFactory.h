...
namespace InstructionFactory {
	...
	ObjectPtr Wall(const Json::Value &root, Point p1, Point p2, Point p3, Point p4);
	...
	ObjectPtr MoveTurker(const Json::Value &root, BlinkFrequency freq, Point p1, Point p2);
	...
	ObjectPtr MoveDoorClockwise(const Json::Value &root, BlinkFrequency freq, Point p1, Point p2);
	ObjectPtr MoveDoorCounterClockwise(const Json::Value &root, BlinkFrequency freq, Point p1, Point p2);
