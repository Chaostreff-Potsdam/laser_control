...
copy build\Debug\laserwrapperd.dll Z:\lib_msvc11\LaserControl\bin\laserwrapperd.dll
copy build\Release\laserwrapper.dll Z:\lib_msvc11\LaserControl\bin\laserwrapper.dll

copy build\lib\Debug\laserwrapperd.lib Z:\lib_msvc11\LaserControl\lib\laserwrapperd.lib
